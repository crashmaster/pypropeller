...
class Propeller(object):
    ...
    def execute(self):
        ...
        while self.__executor.get_run_state():
            for sign in itertools.cycle(self.__propeller_characters):
    ...
    def __normalized_desc(self):
        ...
        len_prop_chars = max(len(x) for x in self.__propeller_characters)
